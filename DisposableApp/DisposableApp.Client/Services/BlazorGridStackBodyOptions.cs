...
{
    /// <summary>
    /// cf https://github.com/gridstack/gridstack.js/tree/master/doc#grid-options
    /// </summary>
    public class BlazorGridStackBodyOptions
    {
      ...
      //  public BlazorGridStackBodyAcceptWidgets? AcceptWidgets { get; set; }
        public object? AcceptWidgets { get; set; }
    ...
    public class BlazorGridStackDraggableOptions
    {
        ...
        /// </summary>
        public bool? Scroll { get; set; } // YG : ne semble pas fonctionner

        /// <summary>
        /// pause?: boolean | number - if set (true | msec), dragging placement (collision) 
        /// will only happen after a pause by the user. Note: this is Global
        /// </summary>
